...
{   
    ...
    public async Task<IActionResult> Details(int id)
    {
        ...
        var computers = await _context.Computers.Where(c => c.AssignedEmployeeId == id).ToListAsync();
        var softwares = await _context.Software.Where(s => s.AssignedEmployeeId == id).ToListAsync();
        var supplies = await _context.Supplies.Where(s => s.AssignedEmployeeId == id).ToListAsync();
